...
lr = LogisticRegression(max_iter=1500).fit(train, target)
predicted_lr = lr.predict(test)

print('Accuracy: ' + str(metrics.accuracy_score(target_test, predicted_lr)))
print('Precision: ' + str(metrics.precision_score(target_test, predicted_lr)))
print('Recall: ' + str(metrics.recall_score(target_test, predicted_lr)))
print('F1 Score: ' + str(metrics.f1_score(target_test, predicted_lr)))

print('Confusion Matrix:')
draw_confusion_matrix(target_test, predicted_lr, ["Not Obfuscated", "Obfuscated"])
